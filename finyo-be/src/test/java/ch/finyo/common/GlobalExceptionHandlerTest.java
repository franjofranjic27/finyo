...
import ch.finyo.config.SecurityConfig;
...
@Import({SecurityConfig.class, ch.finyo.auth.UserProvisioningFilter.class,
...
class GlobalExceptionHandlerTest {
    ...
    @MockitoBean
    private ch.finyo.auth.UserProvisioningService userProvisioningService;
