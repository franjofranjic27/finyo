...
/**
 * Bulk import payload for fixed costs. Items are cascade-validated at the
 ...
 */
public record FixedCostBulkRequest(
        @NotNull @Size(min = 1, max = 500) List<@Valid FixedCostRequest> items
) {}
