 ...
 *   2. Public endpoints (hello-world, swagger, actuator/health) → accessible without a token
...
class SecurityIT extends BaseIntegrationTest {
    ...
    @Test
    void hello_world_is_publicly_accessible_without_token() throws Exception {
